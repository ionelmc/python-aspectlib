...
When `reporting a bug <https://github.com/ionelmc/python-aspectlib/issues>`_ please include:
...
1. `Fork python-aspectlib on GitHub <https://github.com/ionelmc/python-aspectlib/fork>`_.
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will 
       `run the tests <https://travis-ci.org/ionelmc/python-aspectlib/pull_requests>`_ for each change you add in the pull request.
